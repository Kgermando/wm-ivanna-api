...
class ProdModelRestHandlers {
  final Repository repos;

  ProdModelRestHandlers(this.repos);

  Router get router {
    final router = Router();

    router.get('/<business>/', (Request request, String business) async {
      List<ProductModel> data = await repos.prodRestModels.getAllData(business);
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        data = await repos.prodRestModels.getFromId(int.parse(id));
      } catch (e) {
        print(e);
        return Response(404);
      }
    ...
    router.post('/insert-new-produit-model', (Request request) async {
      ...
      try {
        await repos.prodRestModels.insertData(data);
      } catch (e) {
        print(e);
        return Response(422);
      }
    ...
    router.put('/update-produit-model/', (Request request) async {
      ...
      ProductModel? data =
          await repos.prodRestModels.getFromId(editH.id!); 
      ...
      repos.prodRestModels.update(data);
      return Response.ok(jsonEncode(data.toJson()));
    });
    ...
    router.delete('/delete-produit-model/<id>',
      ...
      repos.prodRestModels.deleteData(int.parse(id!));
    ...
    router.all(
      '/<ignored|.*>',
      (Request request) =>
          Response.notFound('La Page produit-model Rest n\'est pas trouvé'),
    );

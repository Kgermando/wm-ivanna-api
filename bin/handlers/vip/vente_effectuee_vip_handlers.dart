...
class VenteEffectueeVipHandlers {
  final Repository repos;

  VenteEffectueeVipHandlers(this.repos);

  Router get router {
    final router = Router();

    router.get('/<business>/', (Request request, String business) async {
      List<VenteRestaurantModel> data = await repos.venteEffectueeVips.getAllData(business);
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        data = await repos.venteEffectueeVips.getFromId(int.parse(id));
      } catch (e) {
        print(e);
        return Response(404);
      }
    ...
    router.get('/vente-chart/<business>', (Request request, String business) async {
      List<VenteChartRestaurantModel> data = await repos.venteEffectueeVips.getAllDataChart(business);
      return Response.ok(jsonEncode(data));
    });

    router.get('/vente-chart-day/<business>', (Request request, String business) async {
      List<CourbeVenteRestaurantModel> data = await repos.venteEffectueeVips.getAllDataChartDay(business);
      return Response.ok(jsonEncode(data));
    });

    router.get('/vente-chart-month/<business>', (Request request, String business) async {
      List<CourbeVenteRestaurantModel> data = await repos.venteEffectueeVips.getAllDataChartMounth(business);
      return Response.ok(jsonEncode(data));
    });

    router.get('/vente-chart-year/<business>', (Request request, String business) async {
      List<CourbeVenteRestaurantModel> data = await repos.venteEffectueeVips.getAllDataChartYear(business);
      return Response.ok(jsonEncode(data));
    });
    ...
    router.put('/update-vente/', (Request request) async {
      ...
      VenteRestaurantModel? data =
          await repos.venteEffectueeVips.getFromId(editH.id!); 
    ...
    router.delete('/delete-vente/<id>', (Request request, String id) async {
      ...
      repos.venteEffectueeVips.deleteData(int.parse(id!));
    ...
    router.all(
      '/<ignored|.*>',
      (Request request) =>
          Response.notFound('La Page venteEffectueeVips n\'est pas trouvé'),
    );

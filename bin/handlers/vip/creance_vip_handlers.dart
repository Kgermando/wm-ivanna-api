...
class CreanceVipHandlers {
  final Repository repos;

  CreanceVipHandlers(this.repos);

  Router get router {
    final router = Router();

    router.get('/<business>/', (Request request, String business) async {
      List<CreanceRestaurantModel> data = await repos.creanceVips.getAllData(business);
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        data = await repos.creanceVips.getFromId(int.parse(id));
      } catch (e) {
        print(e);
        return Response(404);
      }
    ...
    router.put('/update-creance/', (Request request) async {
      ...
      CreanceRestaurantModel? data =
          await repos.creanceVips.getFromId(editH.id!);
    ...
    router.delete('/delete-creance/<id>',
      ...
      repos.creanceVips.deleteData(int.parse(id!));

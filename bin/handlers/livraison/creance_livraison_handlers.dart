...
class CreanceLivraisonHandlers {
  final Repository repos;

  CreanceLivraisonHandlers(this.repos);

  Router get router {
    final router = Router();

    router.get('/<business>/', (Request request, String business) async {
      List<CreanceRestaurantModel> data = await repos.creanceLivraisons.getAllData(business);
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        data = await repos.creanceLivraisons.getFromId(int.parse(id));
      } catch (e) {
        print(e);
        return Response(404);
      }
    ...
    router.put('/update-creance/', (Request request) async {
      ...
      CreanceRestaurantModel? data =
          await repos.creanceLivraisons.getFromId(editH.id!);
    ...
    router.delete('/delete-creance/<id>',
      ...
      repos.creanceLivraisons.deleteData(int.parse(id!));

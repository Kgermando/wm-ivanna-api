...
class CreanceTerrasseHandlers {
  final Repository repos;

  CreanceTerrasseHandlers(this.repos);

  Router get router {
    final router = Router();

    router.get('/<business>/', (Request request, String business) async {
      List<CreanceRestaurantModel> data = await repos.creanceTerrasses.getAllData(business);
    ...
    router.get('/<id>', (Request request, String id) async {
      ...
      try {
        data = await repos.creanceTerrasses.getFromId(int.parse(id));
      } catch (e) {
        print(e);
        return Response(404);
      }
    ...
    router.post('/insert-new-creance', (Request request) async {
      ...
      try {
        await repos.creanceTerrasses.insertData(data);
      } catch (e) {
        print(e);
        return Response(422);
      }
    ...
    router.put('/update-creance/', (Request request) async {
      ...
      CreanceRestaurantModel? data =
          await repos.creanceTerrasses.getFromId(editH.id!);
      ...
      repos.creanceTerrasses.update(data);
      return Response.ok(jsonEncode(data.toJson()));
    });
    ...
    router.delete('/delete-creance/<id>',
      ...
      repos.creanceTerrasses.deleteData(int.parse(id!));
